                ...
                <ul class="nav navbar-nav float-right">
                    ...
                    <li class="dropdown dropdown-language nav-item"><a class="dropdown-toggle nav-link" id="dropdown-flag" href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        ...
                        <div class="dropdown-menu" aria-labelledby="dropdown-flag">
                            <a class="dropdown-item" href="/admin/welcome/en" data-language="en"><i class="flag-icon flag-icon-us"></i> {{__('main.English')}}</a>
                            <a class="dropdown-item" href="/admin/welcome/ar" data-language="ar"><i class="flag-icon flag-icon-eg"></i>  {{__('main.Arabic')}}</a>
                        </div>
                    </li>
